    ...
    return (
        <>
            <section className="w-full h-auto flex items-center justify-center sm:py-12 p-6">
                <div className="w-full sm:w-[900px] sm:max-w-[1000px] bg-color-bg shadow-md backdrop-blur-3xl rounded-lg sm:py-6 sm:px-8 p-4 flex flex-col gap-5">
                    <form onSubmit={handleRegister} className="w-full flex flex-col gap-5">
                        ...
                        <div className="w-full flex items-center justify-center">
                            <button
                                type="submit"
                                className="w-full py-3 px-4 bg-[#d2b48c] text-white border-none font-bold outline-none rounded-lg mt-3"
                            >
                                Register
                            </button>
                        </div>
                        ...
                        <div className="flex items-center justify-center w-full gap-1">
                            ...
                            <span>
                                <Link to={"/login"} className="text-[1rem] text-color-primary font-[500]">
                                    Login
                                </Link>
                            </span>
                        </div>
